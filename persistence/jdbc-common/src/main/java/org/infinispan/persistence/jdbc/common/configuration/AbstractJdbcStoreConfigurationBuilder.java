...
public abstract class AbstractJdbcStoreConfigurationBuilder<T extends AbstractJdbcStoreConfiguration, S extends AbstractJdbcStoreConfigurationBuilder<T, S>> extends
   ...
   public S manageConnectionFactory(boolean manageConnectionFactory) {
      attributes.attribute(AbstractJdbcStoreConfiguration.MANAGE_CONNECTION_FACTORY).set(manageConnectionFactory);
      return self();
   }
   ...
   public void validate() {
      super.validate();
      boolean manageConnectionFactory = attributes.attribute(AbstractJdbcStoreConfiguration.MANAGE_CONNECTION_FACTORY).get();
