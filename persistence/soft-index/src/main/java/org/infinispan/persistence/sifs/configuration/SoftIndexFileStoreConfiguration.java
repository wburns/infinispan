...
public class SoftIndexFileStoreConfiguration extends AbstractNonSharedSegmentedConfiguration<SoftIndexFileStoreConfiguration> {
   ...
   public SoftIndexFileStoreConfiguration newConfigurationFrom(int segment) {
      ...
      set.attribute(DATA_LOCATION).set(dataLocation + "-" + segment);
      String indexLocation = set.attribute(INDEX_LOCATION).get();
      set.attribute(INDEX_LOCATION).set(indexLocation + "-" + segment);
