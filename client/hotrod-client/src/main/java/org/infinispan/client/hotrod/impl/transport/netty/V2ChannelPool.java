 ...
 */
public class V2ChannelPool implements ChannelPool {
   ...
   private static final Log log = LogFactory.getLog(V2ChannelPool.class);
   ...
   public V2ChannelPool(EventExecutor executor, SocketAddress address, ChannelInitializer newChannelInvoker,
                 ExhaustedAction exhaustedAction, BiConsumer<ChannelPool, ChannelFactory.ChannelEventType> connectionFailureListener,
   ...
   public void releaseClosedChannel(Channel channel, ChannelRecord channelRecord) {
      ...
      connectionFailureListener.accept( this, idle ? ChannelFactory.ChannelEventType.CLOSED_IDLE :
            ChannelFactory.ChannelEventType.CLOSED_ACTIVE);
   }
