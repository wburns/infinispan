...
public class HotRodHeader {
   ...
   public HotRodHeader(HotRodOperation op, byte version, long messageId, String cacheName, int flag, short clientIntel, int topologyId, MediaType keyType, MediaType valueType, Map<String, String> otherParams) {
      this.op = op;
