...
public enum HotRodOperation {
   ...
   ADD_NEAR_CACHE_CLIENT_LISTENER(HotRodConstants.ADD_NEAR_CACHE_LISTENER_REQUEST, HotRodConstants.ADD_NEAR_CACHE_LISTENER_REQUEST + 1, EnumSet.of(OpReqs.REQUIRES_AUTH)),
