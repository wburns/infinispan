...
public abstract class ProtocolServerConfiguration<T extends ProtocolServerConfiguration> extends ConfigurationElement<T> {
   ...
   @Deprecated
   /**
    * This method only returns the number of available processors and is not configurable and will be removed later
    * @deprecated since 14.0 to be removed in 16.0
    */
