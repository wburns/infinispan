...
@Test(groups = "unit", testName = "loaders.astyanax.AstyanaxCacheStoreTest")
public class AstyanaxCacheStoreTest extends BaseCacheStoreTest {
   ...
   protected CacheStore createCacheStore() throws Exception {
      AstyanaxCacheStore cs = new AstyanaxCacheStore();
      AstyanaxCacheStoreConfig clc = new AstyanaxCacheStoreConfig();
