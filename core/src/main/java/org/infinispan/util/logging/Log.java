...
// void warnConfigurationForAnnotationMissing(String name);
   ...
   void errorSendingResponse(long requestId, org.jgroups.Address origin, Object command, @Cause Throwable t);
...
//   void corruptDataSuccessfulMigrated(String cacheName, int entries);
   ...
   @Message(value = "Query module not found. Add infinispan-query to the classpath.", id = 695)
