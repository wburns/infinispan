...
import org.infinispan.reactive.publisher.impl.MaybeValueRetainedFunction;
 ...
 * @param <R>
 */
public final class CacheStreamIntermediatePublisher<R> implements MaybeValueRetainedFunction<Publisher<Object>, Publisher<R>>, InjectableComponent {
   ...
   @Override
   public boolean retainsOriginalValue() {
      for (IntermediateOperation intOp : intOps) {
