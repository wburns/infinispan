...
public class SingleFileStoreConfiguration extends AbstractNonSharedSegmentedConfiguration<SingleFileStoreConfiguration> implements Matchable<SingleFileStoreConfiguration> {
