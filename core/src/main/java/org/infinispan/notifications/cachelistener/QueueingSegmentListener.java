 ...
 * @since 7.0
 */
public interface QueueingSegmentListener<K, V, E extends Event<K, V>> extends Predicate<SegmentCompletionPublisher.Notification<CacheEntry<K, V>>> {
    ...
    */
   @Override
   boolean test(SegmentCompletionPublisher.Notification<CacheEntry<K, V>> cacheEntryNotification) throws Throwable;
