...
public class SingleFileGracefulShutdownMigrationTest extends AbstractInfinispanTest {
   ...
   Object[][] singleTypes() {
      return new Object[][]{
            ...
            // MAGIC_11_0
            {"sfs/11_0/all-entries-java-serialization.dat", Marshaller.JAVA_SERIALIZATION, 1003},
            // MAGIC_12_0 created on 12.1.x
            {"sfs/12_0/all-entries-java-serialization.dat", Marshaller.JAVA_SERIALIZATION, 1003},
            // 11.x -> 12.1.x migration resulting in corrupt data
            {"sfs/corrupt/all-entries.dat", Marshaller.PROTOSTREAM, 2003},
            // MAGIC_12_0 created on 12.1.x
            {"sfs/12_0/all-entries.dat", Marshaller.PROTOSTREAM, 1003},
      };
   }

   @Test(dataProvider = "testFiles")
   public void testAllEntriesRecovered(String fileName, Marshaller marshallerType, int numEntries) throws Exception {
