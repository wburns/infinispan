...
public class StateTransferPessimisticTest extends MultipleCacheManagersTest {
   ...
   public void testStateTransfer() throws Exception {
      ...
      waitUntilDataContainerWillBeIteratedOn(cache(0), barrier);
   ...
   protected void waitUntilDataContainerWillBeIteratedOn(final Cache<?, ?> cache, final CyclicBarrier barrier) {
